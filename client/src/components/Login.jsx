...
import { getUser , clearTimer , setTimer} from '../features/UserSlice';
                ...
                <Row className="justify-content-center">
                    <Col md="6" lg="4">
                        <div className="p-5 rounded-4 shadow-lg" style={{backgroundColor : "#0F172A" }}>
                            <h2 className="text-white text-center mb-4 fw-bold display-6">Login</h2>
                            ...
                            <form className="div-form">
                                <FormGroup>
                                    ...
                                    />
                                    <p className="mt-3 mb-0" style={{color : "#FF3838" }}>{errors.email?.message}</p>
                                </FormGroup>
                                ...
                                <FormGroup>
                                    ...
                                    <input
                                        ...
                                        style={{ backgroundColor: '#374151', borderColor: '#4B5563', color: 'white' }}
                                    />
                                    <p className="mt-3 mb-0" style={{color : "#FF3838" }}>{errors.password?.message}</p>
                                </FormGroup>
                                ...
                                <FormGroup className="text-center">
                                    <Label className="text-light">
                                        <Link to="/" className="text-white-400 text-decoration-none">
                                           Back To Home
                                        </Link>
                                    </Label>
                                </FormGroup>
