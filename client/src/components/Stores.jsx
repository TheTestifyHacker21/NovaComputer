  ...
  const stores = [
    {
      ...
      address: "123 Main St, Tech City, CA 94025",
      lat: 23.7100,
      lng: 58.1500
    },
    {
      ...
      address: "456 Oak Ave, Tech City, CA 94026",
      lat: 23.7000,
      lng: 58.1600
    },
    {
      ...
      address: "789 Pine Rd, Tech City, CA 94027",
      lat: 23.6900,
      lng: 58.1400
    },
    {
      ...
      address: "321 Elm St, Tech City, CA 94028",
      lat: 23.7200,
      lng: 58.1700
    }
  ];
      ...
      <div className="container py-5">
        <div className="row justify-content-center">
          <div className="col-lg-10">
              ...
              <div className="d-flex justify-content-between align-items-center mb-4">
                <div>
                  ...
                  {location ? (
                    ...
                    <p className="text-light-emphasis mb-0">Click the button to find your location</p>
                  )}
                </div>
                <button 
              ...
              <div className="d-flex flex-column gap-3">
                {stores.map(store => {
                  ...
                  return (
                    <div 
                      key={store.id} 
                      className={`bg-dark rounded-3 p-3 hover-bg-light transition ${
                    ...
                    >
                      <div className="d-flex align-items-start gap-3">
                        ...
                        <div className="flex-grow-1">
                          ...
                          <p className="text-light-emphasis mb-0">{store.address}</p>
                        </div>
                      </div>
                    </div>
                  );
            ...
            <div className="bg-secondary rounded-3 p-4 mt-4">
